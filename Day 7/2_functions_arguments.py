# The input to a function are called argruments / parameters
...
# 2. Default Argument
# 3. Artitrary Argument

# 1. Positional Arguments
# They are compulsory arguments of a function
...
# 2. Default Arguments
# Default arguments have some defualt value assigned to it which is used only if the value is not passed during the function call.
